<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageNuevo.master" AutoEventWireup="true" CodeFile="GestionLaborarios.aspx.cs" Inherits="academic_private_reservalab_GestionLaborarios" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
      <div class="row">
        ...
        <div class="col-md-12 text-right">
            <asp:Button ID="btnNuevoLab" runat="server" Text="Nuevo laboratorio" CssClass="btn btn-primary" OnClick="btnNuevoLab_Click"/>
        </div>  
    </div>  
